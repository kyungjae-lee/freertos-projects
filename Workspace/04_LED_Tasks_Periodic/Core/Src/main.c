...
static void led_green_task_handler(void *parameters)
{
	...
	while (1)
	{
		...
		vTaskDelayUntil(&last_wakeup_time, pdMS_TO_TICKS(1000));	// non-blocking delay
	}
}
static void led_orange_task_handler(void *parameters)
{
	...
	while (1)
	{
		...
		vTaskDelayUntil(&last_wakeup_time, pdMS_TO_TICKS(800));	// non-blocking delay
	}
}
...
static void led_red_task_handler(void *parameters)
{
	...
	while (1)
	{
		...
		vTaskDelayUntil(&last_wakeup_time, pdMS_TO_TICKS(400));	// non-blocking delay
	}
}
